...
tags:
  ...
  - remove
  - Nokia 8110
slug: blog/kai-os-remove-default-pre-installed-bloatware-apps
comments: true
...
This file is located in /data which was previously not accessible for us. Just pull it using `adb pull data/local/webapps/webapps.json`.
