...
categories:
  - hugo
slug: blog/hugo-custom-404-page-from-content-markdown
comments: true
---
...
In order to test this page (locally) you will need to navigate manually to (by default) `http://localhost:1313/404.html`.
