...
tags:
  ...
  - web apps
  - tutorial
slug: blog/sideloading-and-deploying-apps-to-kai-os
comments: true
...
In this case just run `adb forward tcp:6000 localfilesystem:/data/local/debugger-socket` from Terminal and try again.
...
Anyway, if you have question, please feel free to [contact me](/contact/)
