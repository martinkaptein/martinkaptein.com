...
tags:
  ...
  - KeePass
  - Authenticator
slug: blog/keepass-and-gauth-totp-for-kai-os-nokia-8110
comments: true
...
By the way, here is the homepage of the original developer: [bitbucket.org/namn/browsepass/src/master/](https://bitbucket.org/namn/browsepass/src/master/).
...
Also, feel free to tell me, if any of the links stop working, or something changes. Last but not least, I am happy to hear suggestions on how to make this process even easier.
